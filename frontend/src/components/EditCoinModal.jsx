...
const EditCoinModal = ({ isOpen, onClose, coinId, onSuccess }) => {
  ...
  const fetchData = async () => {
    try {
      ...
      if (coin) {
        ...
        setCurrentFrontImage(`data:image/jpeg;base64,${coin.frontImageBase64 || coin.imageBase64}`);
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40">
      <div className="bg-white rounded-lg shadow-2xl max-w-2xl w-full relative max-h-[90vh] overflow-y-auto">
        <button
          className="absolute top-3 right-3 text-gray-500 hover:text-gray-800 text-2xl font-bold z-10 sticky top-0"
          onClick={onClose}
          aria-label="Close"
        >
          ×
        ...
        <div className="p-6">
          {fetching ? (
            ...
            <>
              <h1 className="text-3xl font-bold text-gray-800 mb-5">Edit Coin</h1>
